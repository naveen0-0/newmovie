...
export default function NowPlayingMovies({ setIndex, setMovieId }) {
  const [movies, setMovies] = useState([])
  const [loading, setLoading] = useState(true)


  const getPopularMovies = async () => {
    let { data } = await axios.get("https://api.themoviedb.org/3/movie/now_playing?api_key=f594e5214f71ed2cde6bdd2ec00f2282");

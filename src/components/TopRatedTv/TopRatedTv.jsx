...
export default function TopRatedTv({ setTvId, setTabIndex }) {

  const [ tvShows, setTvShows ] = useState([])
  const [ loading, setLoading ] = useState(true)

  const getPopularTvShows = async () => {
    let { data } = await axios.get("https://api.themoviedb.org/3/tv/top_rated?api_key=f594e5214f71ed2cde6bdd2ec00f2282")
